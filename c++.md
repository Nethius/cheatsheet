...
* **STL**: <a name="4"></a>
    * **std::forward**: <a name="4.1"></a> #TODO https://habr.com/ru/post/8.42639/
...
* **Классы структуры**: <a name="7"></a>
    ...
    * **Абстрактный класс**: <a name="7.3"></a> Класс, в котором определена чисто виртуальная функция. Что запрещает создавать экземпляр этого класса
    ...
    * **Explicit-конструктор**: <a name="7.5"></a>  
* **Шаблоны**: <a name="8"></a>
...
* **Всякое**: <a name="11"></a>
    ...
    * **Функторы/Лябмда-функции**: <a name="11.2"></a> #TODO

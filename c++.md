...
* **Наследование**: <a name="2"></a>
    ...
    * **Публичное, приватное и протектед наследование**: <a name="2.2"></a> #TODO
    * **Множественное наследование**: <a name="2.3"></a>
    * **Виртуальное наследование**: <a name="2.3"></a>
* **Умные указатели**: <a name="3"></a>
    ...
    * Как лучше создавать умные указатели "std::make_unique<A>()" или "std::unique_ptr<A>(new A())"? Почему?
    * **unique_ptr**: <a name="3.2"></a>
    * **shared_ptr**: <a name="3.3"></a> как устроен шаред и вик птр (какие счетчики ссылок и когда удаляется контрол блок)
        * Control block - 
        * Потокобезопасноть - 
        * Цикличные ссылки -
    * **weak_ptr**: <a name="3.4"></a>
    * **make_shared/unique**: <a name="3.4"></a>
* **STL**: <a name="4"></a>
...
* **Классы структуры**: <a name="7"></a>
    ...
    * **Абстрактный класс**: <a name="7.3"></a> Класс, в котором определена хотя бы одна чисто виртуальная функция. Что запрещает создавать экземпляр этого класса
    ...
    * **Порядок инициализации конструкторов/деструкторов**: <a name="7.1"></a> #TODO
* **Шаблоны**: <a name="8"></a>

...
* **SOLID**: <a name="2"></a> #TODO https://habr.com/ru/company/1cloud/blog/522258/
    ...
    * **Open-Closed Principle** - должна быть возможность расширить класс без его изменения (полиморфизм, DI, инкапсуляция)
    * **Liskov Substitution Principle** - функции, которые используют базовый тип, должны иметь возможность использовать подтипы базового типа, не зная об этом (или поведение наследуемых классов не должно противоречить поведению, заданному базовым классом)
